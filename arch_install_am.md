...
Այնուհետև հարկավոր է գրել պատկերը սկավառակի/USB կրիչի վրա: Եթե գրում եք Windows-ով օգտագործեք *Win32 Disk Imager* գործիքը, եթե լինուքսից՝ *dd* հրամանը: Վիրտուալ մեքենայի վրա տեղադրելու համար հարկավոր է ուղղակի միացնել ISO պատկերը որպես սկավառակ: 
